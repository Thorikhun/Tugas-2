              ...
              children: [
                Row(
                  children: [
                    ...
                    const Spacer(),
                    Text('065120188', style: vkTextCardBold),
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                const Spacer(),
                Text('Muhammad Thariq', style: vkTextLightGrey),
              ],
            ),
          ),
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                const Spacer(),
                Text('Thariq', style: vkTextLightGrey),
              ],
            ),
          ),
          const Divider(color: Color(0xffee8301)),
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Komplek Laladon Indah Jl.Suralaya 1 No.11 Ciomas Bogor',
